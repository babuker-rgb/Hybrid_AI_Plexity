...
# ================================================================
# SAFE HELPER FUNCTIONS (NO ARRAY CONDITIONS)
# ================================================================
...
class MultiTaskPINN(nn.Module):
    ...
    def compute_loss(self, X_scaled, X_raw, y_true, y_scaler, epoch=0, total_epochs=ADAM_EPOCHS):
        ...
        data_loss = (W_DENSITY * loss_dens + W_TENSILE * loss_tensile + W_ER * loss_er +
                     10.0 * loss_disin + 10.0 * (loss_tau + loss_beta))
        ...
        efrf_penalty = torch.mean(torch.relu(efrf_real - 0.50) ** 2) * 100.0
        ...
        physics_loss = (1.0 * (heckel_loss + efrf_penalty) +
...
def load_or_train():
    ...
    st.caption("🔄 Training full model (15k samples, up to 800 epochs)...")
